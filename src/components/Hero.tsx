...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center relative px-6 md:px-16 lg:px-24 py-20">
      <div className="w-full max-w-6xl mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-14 lg:gap-20 items-center">
        <div>
          <motion.div
          ...
          >
            <span className="px-3 py-1 text-[11px] uppercase tracking-wider rounded-full border border-border text-muted-foreground">
              Node.js
            </span>
            <span className="px-3 py-1 text-[11px] uppercase tracking-wider rounded-full border border-border text-muted-foreground">
              AWS
        ...
        >
          <div className="rounded-[2rem] overflow-hidden border border-border bg-muted/30">
            <img
              src={pic}
              alt="Ghazali Hussain"
